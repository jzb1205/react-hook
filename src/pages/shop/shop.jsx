...
class Shop extends Component {
  ...
  initData = async id => {
    let obj = {
      latitude: this.props.geohash[0] || 118.170094294257,
      longitude: this.props.geohash[1] || 24.474107883956105
    };
                                      ...
                                      <div className='menu-detail-list' key={foodIndex}>
                                        ...
                                        <footer className='menu-detail-footer'>
                                              ...
                                              <div className='add-del-icon'>
                                                <div className='icon-wuuiconsuoxiao' onClick={this.handleAddFoodCount.bind(this, food.satisfy_rate, -1)}></div>
                                                {/* <div >{this.state.foodList[food.satisfy_rate].rating}</div> */}
                                                <div className='icon-wuuiconxiangjifangda' onClick={this.handleAddFoodCount.bind(this, food.satisfy_rate, 1)}></div>
                                              </div>
                                        </footer>
                                      </div>
                                    )
